    ...
    public void setPhotoModeParameters() {
        lockRun(new Runnable() {
            ...
            public void run() {
                ...
                //add by xiaodong.cheng 20160120 start
                Log.i(TAG, "setPhotoModeParameters() setZSDMode1:"+getZsdMode());
                if (mActivity.getResources().getString(R.string.pref_camera_zsd_default).equals("on") && ((com.android.camera.CameraActivity)mActivity).isNonePickIntent()){        
                    mParameters.setZSDMode("on");
                    Log.i(TAG, "setPhotoModeParameters() setZSDMode2:"+getZsdMode());
                }
                //end
